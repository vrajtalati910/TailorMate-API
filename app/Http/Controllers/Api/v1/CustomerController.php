...
class CustomerController extends Controller
{
    ...
    public function show(Customer $customer)
    {
        return response()->json([
            ...
            'data' => $customer->load('customerItems', 'customerItems.item', 'customerItems.styleRecords', 'customerItems.measurementRecords'),
            'status' => 1
        ]);
    }
    ...
    public function itemsDetails(CustomerItem $customerItems)
    {
        return response()->json([
            ...
            'data' => $customerItems->load('item','measurementRecords', 'styleRecords'),
            'status' => 1
        ]);
    }
}
